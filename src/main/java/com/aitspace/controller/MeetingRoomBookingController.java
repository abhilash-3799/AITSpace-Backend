...
import com.aitspace.service.MeetingRoomBookingService;
...
public class MeetingRoomBookingController {
    ...
    @PostMapping
    public MeetingRoomBookingResponseDTO create(@Valid @RequestBody MeetingRoomBookingRequestDTO request) {
